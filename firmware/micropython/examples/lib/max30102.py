...
class MAX30102():
    ...
    def __init__(self, i2c, address=0x57):#, gpio_pin=7):
        ...
        #self.bus = I2C(self.channel, scl=Pin(1), sda=Pin(0), freq=100000)
        ...
        reg_data = self.bus.readfrom_mem(self.address, REG_INTR_STATUS_1, 1)
    ...
    def shutdown(self):
        ...
        Shutdown the device.
        """
        self.bus.writeto_mem(self.address, REG_MODE_CONFIG, b'\x80')
    ...
    def reset(self):
        ...
        """
        self.bus.writeto_mem(self.address, REG_MODE_CONFIG, b'\x40')
    ...
    def setup(self, led_mode=0x03):
        ...
        self.bus.writeto_mem(self.address, REG_MODE_CONFIG, led_mode.to_bytes(1, 'little'))
        # 0b 0010 0111
    ...
    def read_sequential(self, amount=100):
        ...
        for i in range(amount):
            while((self.bus.readfrom_mem(self.address, REG_INTR_STATUS_1, 1)[0] & 0x40) == 0x00):
