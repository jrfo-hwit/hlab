// para compilar rode no terminal os seguintes comandos
// 1] cd build							(entrar no diretorio de build)
// 2] rm -rf ./*						(apagar todos os arquivos)
// 3] cmake -DPICO_COPY_TO_RAM=1 ..		(cmake prepara o projeto para ser compilado)
// 4] make								(compila de fato, arquivo hdmi.uf2 fica na pasta build)
...
int main() {
    ...
    */
	...
	for (int i = 0; i < N_BERRIES; ++i) {
		...
		berry[i].img = i % 2 ? HwIT_Logo_128x128 : raspberry_128x128;
		berry[i].log_size = 7;
